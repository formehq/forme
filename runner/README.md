...
```
node runner/index.ts --vault <vault 路径> [--commits N] [--max-files 12] [--max-cards 3] [--slow-layer N] [--dry-run] [--model <m>] [--out <dir>]
