...
- Current gate: R3 is owner-accepted; the privacy-first/minimum-friction P
  ...
  owner-approved; revised T3 is the current unapproved
...
| R4 — Controlled Presence | Aug 5–7 | one curated Third Place with a public Forme Project Room, one public knock, a bounded Private Room path, one reviewed continuation, and one minimum Native Workbench → Forme call | a normal Codex session retrieves durable Twin orientation/body-free typed status without a new chat shell; private canary stays absent; public request → local review → response → bounded Grant lifecycle passes owner acceptance |
...
authority. Revised T3 is the current unapproved gate; T4/T5 also remain open.
...
cards cover the current revised T3 Managed Privacy decision, public lifecycle
...
Native Harness role clarification
  ...
  → revised T3 provider-visibility contract [current]
  → T4/T5
