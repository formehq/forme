...
| [`R4-TECHNICAL-OWNER-REVIEW.md`](./R4-TECHNICAL-OWNER-REVIEW.md) | Start here for R4 technical review: closed P/T1/T2/T3/T4/NH1/NH2 decisions, the current T5 card, and five walkthroughs. |
| [`R4-AGENCY-FIRST-RECALIBRATION.md`](./R4-AGENCY-FIRST-RECALIBRATION.md) | Short audit: the approved minimum-friction T2 Room Operator contract, approved NH1/NH2, Fresh Native Response Session T3, and public-lifecycle T4 boundaries, plus what T5 still decides. |
