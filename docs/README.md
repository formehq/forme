...
| [`R4-GATE-B-RETRY-OWNER-REVIEW.md`](./R4-GATE-B-RETRY-OWNER-REVIEW.md) | Current low-load Owner decision: approve repo-only Retry Construction while keeping real execution and provider calls closed. |
| [`R4-GATE-B-RETRY-CONSTRUCTION-PACKET.md`](./R4-GATE-B-RETRY-CONSTRUCTION-PACKET.md) | Current hash-pinned proposal: split runner construction from later execution, enforce serial/no-ad-hoc work, and preserve the controlling-Agent isolation limitation honestly. |
