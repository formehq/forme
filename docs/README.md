...
| [`R4-TECHNICAL-OWNER-REVIEW.md`](./R4-TECHNICAL-OWNER-REVIEW.md) | Start here for R4 technical review: closed P/T1/T2/T3/T4/NH1/NH2 decisions, fixed T5 email/continuation inputs, the remaining T5 card, and five walkthroughs. |
| [`R4-AGENCY-FIRST-RECALIBRATION.md`](./R4-AGENCY-FIRST-RECALIBRATION.md) | Short audit: the approved minimum-friction T2 Room Operator contract, approved NH1/NH2, Fresh Native Response Session T3, public-lifecycle T4 boundaries, and the remaining T5 decisions. |
| [`R4-TECHNICAL-CONTROL-PACKET.md`](./R4-TECHNICAL-CONTROL-PACKET.md) | Unreconciled historical implementation appendix: its protocol/identity/sync/lifecycle detail remains useful, but its response picker/manifest/32 KiB lane, local runtime topology, former hosting/Guest choices, and over-broad credentials must be rewritten after T5 closes. |
