...
| [`AGENCY-TRUST.md`](./AGENCY-TRUST.md) | Owner-stated privacy-first/minimum-friction direction plus the proposed companion guards and delegation model. |
...
| [`R4-TECHNICAL-OWNER-REVIEW.md`](./R4-TECHNICAL-OWNER-REVIEW.md) | Start here for R4 technical review: ten-minute mental model, T1 public/private Room decision, one agency-formalization check, four remaining technical cards, and five walkthroughs. |
| [`R4-AGENCY-FIRST-RECALIBRATION.md`](./R4-AGENCY-FIRST-RECALIBRATION.md) | Short audit: what minimum-friction agency changes in pending R4 T2–T5 now, what waits, and what human boundaries stay hard. |
| [`R4-TECHNICAL-CONTROL-PACKET.md`](./R4-TECHNICAL-CONTROL-PACKET.md) | Unreconciled implementation appendix: its protocol/identity/sync/lifecycle detail remains useful, but the former Vercel/Supabase and invite-only Guest access recommendations must be rewritten after P and T2–T5 close. |
