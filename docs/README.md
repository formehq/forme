...
| [`R4-GATE-B-OWNER-REVIEW.md`](./R4-GATE-B-OWNER-REVIEW.md) | Low-load Owner decision surface for the exact proposed/unexecuted Gate B Manifest; no provider call is requested. |
| [`R4-GATE-B-SCHEMA-RUNTIME-MIGRATION-MANIFEST.md`](./R4-GATE-B-SCHEMA-RUNTIME-MIGRATION-MANIFEST.md) | Hash-pinned Gate B proposal for repository construction and local/ephemeral PostgreSQL, zero-call Codex, macOS boundary, fake-budget, and cleanup validation. |
