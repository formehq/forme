...
| [`R4-GATE-B-CORE-CORRECTION-CONSTRUCTION-PACKET.md`](./R4-GATE-B-CORE-CORRECTION-CONSTRUCTION-PACKET.md) | Exact proposal awaiting Owner approval: repository-only Core construction with fake physical adapters; no Retry or Provider authority. |
| [`R4-GATE-B-CORE-CORRECTION-CONSTRUCTION-OWNER-REVIEW.md`](./R4-GATE-B-CORE-CORRECTION-CONSTRUCTION-OWNER-REVIEW.md) | Low-load decision surface for the exact Core Construction proposal. |
