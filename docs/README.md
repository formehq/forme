...
| [`R4-TECHNICAL-OWNER-REVIEW.md`](./R4-TECHNICAL-OWNER-REVIEW.md) | Start here for R4 technical review: ten-minute mental model, T1 public/private Room decision, four remaining Owner cards, five walkthroughs, and the boundary between Owner judgment and agent audit. |
