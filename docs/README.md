...
| [`R4-TECHNICAL-OWNER-REVIEW.md`](./R4-TECHNICAL-OWNER-REVIEW.md) | Start here for R4 technical review: ten-minute mental model, closed P/T1 decisions, four remaining technical cards, and five walkthroughs. |
...
| [`R4-TECHNICAL-CONTROL-PACKET.md`](./R4-TECHNICAL-CONTROL-PACKET.md) | Unreconciled implementation appendix: its protocol/identity/sync/lifecycle detail remains useful, but the former Vercel/Supabase and invite-only Guest access recommendations must be rewritten after T2–T5 close. |
